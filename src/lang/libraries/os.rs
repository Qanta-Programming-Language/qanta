use std::{
    collections::HashMap,
    io::{stdin, stdout, Write}, // Cambiado: Se eliminó Echo y se agregó Write
    process::exit,
    rc::Rc,
    time::UNIX_EPOCH,
};

// Eliminada la línea: use crate::lang::tokenizer::TokenType::Echo;
    ...
    pub fn input(args: &[LiteralValue]) -> LiteralValue {
        ...
        match args.len() {
            1 => {
                ...
                stdout().flush().ok(); // Ahora funciona porque importamos Write
